...
public class MainKurdishActivity extends AppCompatActivity
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_buy:
                    amlakapi=new AmlakApiService(MainKurdishActivity.this);
                    amlakapi.getamlakcat("ku",0,svset.getCityId(),new AmlakApiService.OnDoctorReceived() {
                        @Override
                        public void onReceived(AmlakCategory amlakcategory) {
                            Log.e("fiinal",amlakcategory.toString());
                            GroupAdaptor pa1=new GroupAdaptor(MainKurdishActivity.this, amlakcategory.getCategories(),0);
                            recyclegroup.setLayoutManager(new LinearLayoutManager(MainKurdishActivity.this,LinearLayoutManager.HORIZONTAL,false));
                            recyclegroup.setAdapter(pa1);

                            EstateAdaptor estateadaptor=new EstateAdaptor(MainKurdishActivity.this, amlakcategory.getAmlaks());
                            recycleestate.setLayoutManager(new LinearLayoutManager(MainKurdishActivity.this,LinearLayoutManager.VERTICAL,false));
                ...
                case R.id.navigation_rent:
                    amlakapi=new AmlakApiService(MainKurdishActivity.this);
                    amlakapi.getamlakcat("ku",1,svset.getCityId(),new AmlakApiService.OnDoctorReceived() {
                        @Override
                        public void onReceived(AmlakCategory amlakcategory) {
                            Log.e("fiinal",amlakcategory.toString());
                            GroupAdaptor pa1=new GroupAdaptor(MainKurdishActivity.this, amlakcategory.getCategories(),1);
                            recyclegroup.setLayoutManager(new LinearLayoutManager(MainKurdishActivity.this,LinearLayoutManager.HORIZONTAL,false));
                            recyclegroup.setAdapter(pa1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_kurdish);
        ...
        textApiService.gettexts(new TextApiService.OnTextReceived() {
            ...
            public void onReceived(InfoApp infoapp) {
                helpbuy=infoapp.getHelpbuyku();
                helprent=infoapp.getHelprentku();
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.main_kurdish, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.help) {
            ...
            Intent i = new Intent(MainKurdishActivity.this, MainKurdishActivity.class);
            startActivity(i);
            finish();
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent i = new Intent(MainKurdishActivity.this, StateCityActivity.class);
            i.putExtra("lang","ku");
            startActivity(i);
            finish();

        }  else if (id == R.id.nav_tools) {
            Intent i = new Intent(MainKurdishActivity.this, CityActivity.class);
            startActivity(i);
            finish();
