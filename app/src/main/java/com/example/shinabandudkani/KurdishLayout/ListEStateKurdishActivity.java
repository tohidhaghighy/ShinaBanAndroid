...
public class ListEStateKurdishActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_estate_kurdish);
        ...
        if (camefrom==0) {
            ...
            amlakapi.getamlakcatZirDaste("ku", type, id,svset.getCityId(), new AmlakApiService.OnDoctorReceived() {
                @Override
                public void onReceived(AmlakCategory amlakcategory) {
                    EstateAdaptor estateadaptor=new EstateAdaptor(ListEStateKurdishActivity.this, amlakcategory.getAmlaks());
                    searchlist.setLayoutManager(new LinearLayoutManager(ListEStateKurdishActivity.this,LinearLayoutManager.VERTICAL,false));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.list_estate_kurdish, menu);
        return true;
    }
    ...
    private void gotosearchpage(Integer id,Integer type){
        if (id==5 || id==11){
            Intent i = new Intent(ListEStateKurdishActivity.this, Search2Activity.class);
            i.putExtra("id",id);
            i.putExtra("type",type);
            startActivity(i);
        }else if (id==7 || id==13){
            Intent i = new Intent(ListEStateKurdishActivity.this, Search3Activity.class);
            i.putExtra("id",id);
            i.putExtra("type",type);
            startActivity(i);
        }else {
            Intent i = new Intent(ListEStateKurdishActivity.this, Search1Activity.class);
            i.putExtra("id",id);
            i.putExtra("type",type);
            startActivity(i);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent i = new Intent(ListEStateKurdishActivity.this, MainKurdishActivity.class);
            startActivity(i);
            finish();
        }else if (id == R.id.nav_city) {
            Intent i = new Intent(ListEStateKurdishActivity.this, StateCityActivity.class);
            i.putExtra("lang","ku");
            startActivity(i);
            finish();

        }  else if (id == R.id.nav_tools) {
            Intent i = new Intent(ListEStateKurdishActivity.this, CityActivity.class);
            startActivity(i);
            finish();
