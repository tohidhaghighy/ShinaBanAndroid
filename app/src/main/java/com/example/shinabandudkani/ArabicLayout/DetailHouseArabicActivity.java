...
public class DetailHouseArabicActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_house_arabic);
        ...
        amlakapi.getamlakdetail("ar", id,svset.getCityId(), new AmlakApiService.OnAmlakDetailReceived() {
            @Override
            public void onReceived(AmlakDetail amlakdetail) {
                ...
                txtusernameinfo.setText(" اسم المستخدم : "+amlakdetail.getName().toString());
                txtemailinfo.setText(" البريد الإلكتروني : "+amlakdetail.getEmail().toString());
                mailnum=amlakdetail.getEmail().toString();
                txtboardnameinfo.setText(" اسم المكتب : "+amlakdetail.getBoard_Name().toString());
                ...
                EstateAdaptor pa=new EstateAdaptor(DetailHouseArabicActivity.this, amlakdetail.getAllamlak());
                rv.setLayoutManager(new LinearLayoutManager(DetailHouseArabicActivity.this,LinearLayoutManager.VERTICAL,false));
                rv.setAdapter(pa);

                RecyclerView rvproprety=(RecyclerView)findViewById(R.id.property_recycle);
                PropertyAdaptor propadaptor=new PropertyAdaptor(DetailHouseArabicActivity.this, amlakdetail.getAllproperty());
                rvproprety.setLayoutManager(new LinearLayoutManager(DetailHouseArabicActivity.this,LinearLayoutManager.VERTICAL,false));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.detail_house_arabic, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent i = new Intent(DetailHouseArabicActivity.this, MainArabicActivity.class);
            startActivity(i);
            finish();
        }else if (id == R.id.nav_city) {
            Intent i = new Intent(DetailHouseArabicActivity.this, StateCityActivity.class);
            i.putExtra("lang","ar");
            startActivity(i);
            finish();

        }  else if (id == R.id.nav_tools) {
            Intent i = new Intent(DetailHouseArabicActivity.this, CityActivity.class);
            startActivity(i);
            finish();
