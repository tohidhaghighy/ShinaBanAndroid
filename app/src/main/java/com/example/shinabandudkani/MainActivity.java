...
public class MainActivity extends AppCompatActivity
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_buy:
                    amlakapi=new AmlakApiService(MainActivity.this);
                    amlakapi.getamlakcat("en",0,svset.getCityId(),new AmlakApiService.OnDoctorReceived() {
                        @Override
                        public void onReceived(AmlakCategory amlakcategory) {
                            Log.e("fiinal",amlakcategory.toString());
                            GroupAdaptor pa1=new GroupAdaptor(MainActivity.this, amlakcategory.getCategories(),0);
                            recyclegroup.setLayoutManager(new LinearLayoutManager(MainActivity.this,LinearLayoutManager.HORIZONTAL,false));
                            recyclegroup.setAdapter(pa1);

                            EstateAdaptor estateadaptor=new EstateAdaptor(MainActivity.this, amlakcategory.getAmlaks());
                            recycleestate.setLayoutManager(new LinearLayoutManager(MainActivity.this,LinearLayoutManager.VERTICAL,false));
                ...
                case R.id.navigation_rent:
                    amlakapi=new AmlakApiService(MainActivity.this);
                    amlakapi.getamlakcat("en",1,svset.getCityId(),new AmlakApiService.OnDoctorReceived() {
                        @Override
                        public void onReceived(AmlakCategory amlakcategory) {
                            Log.e("fiinal",amlakcategory.toString());
                            GroupAdaptor pa1=new GroupAdaptor(MainActivity.this, amlakcategory.getCategories(),1);
                            recyclegroup.setLayoutManager(new LinearLayoutManager(MainActivity.this,LinearLayoutManager.HORIZONTAL,false));
                            recyclegroup.setAdapter(pa1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textApiService.gettexts(new TextApiService.OnTextReceived() {
            ...
            public void onReceived(InfoApp infoapp) {
                helpbuy=infoapp.getHelpbuyen();
                helprent=infoapp.getHelprenten();
            }
        });
    ...
    public void onBackPressed() {
        ...
        Toast.makeText(this, "2 times to exit", Toast.LENGTH_SHORT).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent i = new Intent(MainActivity.this, StateCityActivity.class);
            i.putExtra("lang","en");
            startActivity(i);
            finish();
